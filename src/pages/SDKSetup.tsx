...
const SDKSetup = () => {
  const steps = [
    {
      id: 1,
      title: "Install Payman SDK",
      description: "Add the Payman SDK to your project using your preferred package manager",
      code: "npm install @payman/sdk\n# or\nyarn add @payman/sdk\n# or\npnpm add @payman/sdk",
      language: "bash"
    },
    {
      id: 2,
      title: "Initialize SDK",
      description: "Set up the Payman SDK with your API credentials",
      code: `import { PaymanSDK } from '@payman/sdk';\n\nconst payman = new PaymanSDK({\n  apiKey: process.env.PAYMAN_API_KEY,\n  environment: 'production' // or 'sandbox'\n});`,
      language: "typescript"
    },
    {
      id: 3,
      ...
      code: `const bountyAgent = await payman.createAgent({\n  name: 'Bounty Manager',\n  type: 'bounty_funding',\n  wallet: {\n    currency: 'USDC',\n    initialBalance: 1000\n  },\n  rules: {\n    autoApprove: true,\n    maxAmount: 500\n  }\n});`,
      language: "typescript"
    },
    {
      id: 4,
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">SDK Setup Guide</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Get started with the Payman SDK in minutes. Build autonomous agents that can think and transact.
          </p>
        </div>
          ...
          {sdkFeatures.map((feature, index) => (
            <Card key={index} className="group hover:shadow-lg transition-all duration-300 cursor-pointer">
              <CardContent className="p-4 text-center">
                ...
                <h3 className="font-semibold mb-1 group-hover:text-blue-600 transition-colors">{feature.title}</h3>
        ...
        {/* Next Steps CTA */}
        <Card className="mt-12 bg-gradient-to-r from-purple-600 to-blue-600 border-0 text-white">
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                variant="secondary" 
                className="group"
                onClick={() => window.open('https://github.com/payman-ai/agent-templates', '_blank')}
              >
                Browse Templates
              </Button>
              <Button 
                ...
                onClick={() => window.open('https://docs.payman.dev/examples', '_blank')}
              >
                View Examples
              </Button>
            </div>
